        ...
        <form onSubmit={handleSubmit} className="modal-body">
          <div className="form-group">
            ...
            <input
              ...
              required
              placeholder="ex curatenie deschidere tura"
            />
          </div>
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              placeholder="descriere task curatenie"
            />
          </div>
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              <select
                ...
                required
                title="selecteaza frecventa"
                aria-label="selecteaza frecventa"
              >
            ...
            <div className="form-group">
              ...
              <select
                ...
                title="selecteaza tura"
                aria-label="selecteaza tura"
              >
          ...
          <div className="form-group">
            ...
            <input
              ...
              required
              title="data si ora termenului"
              aria-label="data si ora termenului"
            />
          </div>
