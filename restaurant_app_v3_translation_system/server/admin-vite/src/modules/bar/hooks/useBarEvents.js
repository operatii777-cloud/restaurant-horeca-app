...
exports.useBarEvents = useBarEvents;
...
function useBarEvents() {
        ...
        var fetchInitialOrders = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.get('/api/orders/orders-display/bar')];
                    case 1:
                        response = _a.sent();
                        if (response.data && Array.isArray(response.data.orders)) {
                            canonicalOrders = response.data.orders.map(orderMapper_1.mapRawOrderToCanonical);
                            setOrders(canonicalOrders);
                            console.log("\u2705 [Bar] Loaded ".concat(canonicalOrders.length, " initial orders"));
                        }
                        return [3 /*break*/, 3];
                    case 2:
                        error_1 = _a.sent();
                        console.error('❌ [Bar] Error fetching initial orders:', error_1);
                        return [3 /*break*/, 3];
    ...
    (0, react_1.useEffect)(function () {
        var handleOrderEvent = function (_a) {
            ...
            var hasBarItems = (_b = canonicalOrder.items) === null || _b === void 0 ? void 0 : _b.some(function (item) { return item.station === 'bar'; });
            if (hasBarItems) {
