...
//   const { t } = useTranslation();
  ...
  const type = searchParams.ge[type] as TipizatType | null;
  const id = searchParams.ge[id];
  const format = (searchParams.ge[format] || 'A4') as 'A4' | 'A5';
  const printerFriendly = searchParams.ge[printerFriendly] === 'true' || searchParams.ge[print] === 'true';
  const monochrome = searchParams.ge[monochrome] === 'true' || searchParams.ge[color] === 'false';
