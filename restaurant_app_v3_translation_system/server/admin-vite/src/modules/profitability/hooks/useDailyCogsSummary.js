...
var useDailyCogsSummary = function (filters) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, profitabilityApi_1.getDailySummary)(filters)];
                case 2:
                    summary = _c.sent();
                    setData(summary);
                    return [3 /*break*/, 5];
                case 3:
                    err_1 = _c.sent();
                    console.error('Error fetching daily COGS summary:', err_1);
    ...
    var chartData = (0, profitabilityMappers_1.mapDailySummaryToChartData)(data);
    var kpiBlocks = (0, profitabilityMappers_1.computeKpiBlocks)(data);
    return {
        data: data,
        chartData: chartData,
        kpiBlocks: kpiBlocks,
...
exports.useDailyCogsSummary = useDailyCogsSummary;
