...
var useCategoryProfitability = function (filters) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, profitabilityApi_1.getCategoryProfitability)(filters)];
                case 2:
                    categories = _c.sent();
                    setData(categories);
                    return [3 /*break*/, 5];
                case 3:
                    err_1 = _c.sent();
                    console.error('Error fetching category profitability:', err_1);
    ...
    var pieChartData = (0, profitabilityMappers_1.mapCategoryProfitabilityToPie)(data);
    return {
        data: data,
...
exports.useCategoryProfitability = useCategoryProfitability;
