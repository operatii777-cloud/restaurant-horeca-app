...
require("./KioskUsersPage.css");
var KioskUsersPage = function () {
    ...
    return (<div className="kiosk-users-page">
      <PageHeader_1.PageHeader title="Utilizatori KIOSK" subtitle="gestionare username si parola pentru ospatari supe"/>
      ...
      <react_bootstrap_1.Card>
        <react_bootstrap_1.Card.Header className="d-flex justify-content-between align-items-center">
          <h5 className="mb-0">
            <i className="fas fa-users me-2"></i>Lista Utilizatori
          </h5>
                  ...
                  {users.map(function (user) { return (<tr key={user.id}>
                      ...
                      <td>
                        <div className="d-flex gap-2">
                          <react_bootstrap_1.Button variant="outline-primary" size="sm" onClick={function () { return handleOpenModal(user); }}>
                            <i className="fas fa-edit"></i>
                          </react_bootstrap_1.Button>
                          <react_bootstrap_1.Button variant={user.is_active ? 'outline-warning' : 'outline-success'} size="sm" onClick={function () { return handleToggleActive(user); }}>
                            <i className={"fas fa-".concat(user.is_active ? 'ban' : 'check')}></i>
                          </react_bootstrap_1.Button>
                          {user.role !== 'admin' && (<react_bootstrap_1.Button variant="outline-danger" size="sm" onClick={function () { return user.id && handleDelete(user.id); }}>
      ...
      <react_bootstrap_1.Modal show={showModal} onHide={handleCloseModal} size="lg" centered>
        <react_bootstrap_1.Modal.Header closeButton>
          <react_bootstrap_1.Modal.Title>
            {editingUser ? (<>
                <i className="fas fa-edit me-2"></i>Editează Utilizator
              </>) : (<>
                <i className="fas fa-plus me-2"></i>Utilizator Nou
              </>)}
          </react_bootstrap_1.Modal.Title>
        ...
        <react_bootstrap_1.Form onSubmit={handleSubmit}>
          ...
          <react_bootstrap_1.Modal.Footer>
            <react_bootstrap_1.Button variant="secondary" onClick={handleCloseModal}>
              <i className="fas fa-times me-2"></i>"Anulează"</react_bootstrap_1.Button>
...
exports.KioskUsersPage = KioskUsersPage;
