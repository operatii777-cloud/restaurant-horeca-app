        ...
        <Card.Body>
          ...
          <div className="row text-center mb-4">
            <div className="col border-end">
              <h4>{(summary.totalRevenue ?? 0).toFixed(2)} RON</h4>
              <small className="text-muted">Venituri Totale</small>
            </div>
            <div className="col border-end">
              <h4>{(summary.totalCOGS ?? 0).toFixed(2)} RON</h4>
              <small className="text-muted">Costul Mărfii Vândute (COGS)</small>
            </div>
            <div className="col">
              <h4>{(summary.grossProfit ?? 0).toFixed(2)} RON</h4>
              ...
              {data.length === 0 ? (
                ...
                data.map((item, index) => (
                  <tr key={index}>
                    ...
                    <td>{(item.revenue ?? 0).toFixed(2)} RON</td>
                    <td>{(item.cogs ?? 0).toFixed(2)} RON</td>
                    <td>{(item.grossProfit ?? 0).toFixed(2)} RON</td>
