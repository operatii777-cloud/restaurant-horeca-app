...
exports.useQueueMonitor = useQueueMonitor;
// import { useTranslation } from '@/i18n/I18nContext';
var react_1 = require("react");
var queueApi_1 = require("../api/queueApi");
var REFRESH_INTERVAL = 3000; // 3 seconds
function useQueueMonitor(autoRefresh) {
    var _this = this;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    setError(null);
                    return [4 /*yield*/, (0, queueApi_1.fetchQueueMonitor)()];
                case 1:
                    result = _a.sent();
                    setData(result);
                    setLoading(false);
                ...
                case 2:
                    err_1 = _a.sent();
                    error_1 = err_1 instanceof Error ? err_1 : new Error('Failed to load queue monitor');
                    setError(error_1);
                    setLoading(false);
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (autoRefresh) {
            var interval_1 = setInterval(loadData, REFRESH_INTERVAL);
