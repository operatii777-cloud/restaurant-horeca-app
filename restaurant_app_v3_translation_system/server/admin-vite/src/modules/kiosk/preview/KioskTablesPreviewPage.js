...
exports.KioskTablesPreviewPage = KioskTablesPreviewPage;
var react_1 = require("react");
require("./KioskTablesPreviewPage.css");
/**
 * KIOSK Tables Preview Page Component
 */
function KioskTablesPreviewPage() {
    ...
    return (<div className="kiosk-preview-page">
      <div className="kiosk-preview-container">
        ...
        <section className="kiosk-preview-variant variant-1">
          ...
          <div className="tables-grid">
            {mockTables.map(function (table) { return (<div key={table.id} className={"table-card table-card--".concat(getStatusClass(table.status))}>
