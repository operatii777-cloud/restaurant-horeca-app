  ...
  return [
    ...
    },
    {
      ...
      cellRenderer: (params) => {
        ...
        if (o?.invoice_id) {
          return (
            <span className="inline-flex items-center gap-1 cursor-pointer text-blue-600 hover:text-blue-800" title="Deschide factura">
        ...
        if (!o?.has_fiscal_receipt) {
          return <span className="text-gray-400 text-xs" title="Nu există bon fiscal">—</span>;
        }
        return <span className="text-yellow-700 hover:text-yellow-900 underline text-xs" title="Generează factura">Generează</span>;
      },
