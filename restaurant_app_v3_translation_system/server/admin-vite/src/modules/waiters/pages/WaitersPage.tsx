...
import { UserPinsSection } from '@/modules/waiters/components/UserPinsSection';
...
export const WaitersPage = () => {
  ...
  const [activeTab, setActiveTab] = useState<'pins' | 'user-pins' | 'kiosk-users'>('pins');
    ...
    <div className="waiters-page" data-page-ready={isReady ? 'true' : 'false'}>
      ...
      <div className="waiters-tabs" style={{ marginBottom: '2rem', borderBottom: '2px solid #e0e0e0' }}>
        ...
        <button
          ...
          className={`waiters-tab ${activeTab === 'user-pins' ? 'active' : ''}`}
          style={{
            padding: '0.75rem 1.5rem',
            border: 'none',
            background: 'transparent',
      ...
      {activeTab === 'user-pins' && <UserPinsSection />}
