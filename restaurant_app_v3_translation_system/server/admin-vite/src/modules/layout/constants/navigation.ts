...
export const NAVIGATION_ITEMS: NavItem[] = [
  ...
  // ========================================
  {
    ...
    children: [
      ...
      { label: 'Wallet cashback curieri', path: '/delivery/courier-wallet', icon: '💰', badge: 'nou' },
  ...
  // ========================================
  {
    ...
    children: [
      ...
      { label: 'Jurnal aprobări manager', path: '/reports/manager-approvals', icon: '🛡️', badge: 'nou' },
