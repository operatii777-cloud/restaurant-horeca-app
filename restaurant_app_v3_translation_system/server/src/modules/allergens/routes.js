...
router.get('/products', controller.getProductsWithAllergens);
router.post('/recalculate-all', controller.recalculateAllProductsAllergens);
router.post('/recalculate/:productId', controller.recalculateProductAllergens);
