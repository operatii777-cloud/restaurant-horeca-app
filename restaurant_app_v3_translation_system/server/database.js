...
function initializeDb(db) {
  return new Promise((resolve, reject) => {
    ...
    db.serialize(() => {
      ...
      // COMMENTED OUT: This duplicates the enterprise multi-tenant vat_rates table at line 3613
        ...
        if (row.count === 0) {
          ...
          seedProducts(db)
            .then((insertedCount) => {
              ...
              // Ambalajele nu mai sunt adăugate automat în meniu (gestionare prin F.T.P.)
              return Promise.resolve();
            })
            .then(() => {
