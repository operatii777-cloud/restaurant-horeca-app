    ...
    <div className="executive-dashboard-page">
              ...
              <div className="d-flex justify-content-between align-items-start">
                <div>
                  ...
                  <small className={`d-block mt-1 ${metrics.today.revenue_change_percent >= 0 ? 'text-success' : 'text-danger'}`}>
                    {formatPercent(metrics.today.revenue_change_percent)} vs ieri
                  </small>
                </div>
              ...
              <div className="d-flex justify-content-between align-items-start">
                <div>
                  ...
                  <small className={`d-block mt-1 ${metrics.today.orders_change_percent >= 0 ? 'text-success' : 'text-danger'}`}>
                    {formatPercent(metrics.today.orders_change_percent)} vs ieri
                  </small>
                </div>
                <div className="kpi-icon">📦</div>
              </div>
          ...
          <Card>
            ...
            <Card.Body>
              {metrics.critical_stock.items.length === 0 ? (
                <p className="text-muted mb-0">"nu exista stocuri critice"</p>
              ) : (
          ...
          <Card>
            ...
            <Card.Body>
              {metrics.pending_orders.orders.length === 0 ? (
                <p className="text-muted mb-0">"nu exista comenzi in asteptare"</p>
              ) : (
                <Table striped hover size="sm">
                  <thead>
                    <tr>
      ...
      <div className="text-center mb-4">
        <Button onClick={loadMetrics} disabled={loading}>
          {loading ? (
            <>
              <Spinner size="sm" className="me-2" />"se actualizeaza"</>
          ) : (
            'Actualizează Datele'
          )}
        </Button>
