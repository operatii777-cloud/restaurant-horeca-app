...
//   const { t } = useTranslation();
  ...
  const handleDelete = async (id: number) => {
    if (!window.confirm('Ești sigur că vrei să ștergi această comandă?')) return;
    ...
    <div className="supplier-orders-page">
      ...
      <Modal show={showModal} onHide={handleCloseModal} size="lg" centered>
        <Modal.Header closeButton>
          <Modal.Title>{editingOrder ? 'Editează Comandă' : 'Comandă Nouă'}</Modal.Title>
        </Modal.Header>
        <Form onSubmit={handleSubmit}>
          <Modal.Body>
            ...
            <Form.Group className="mb-3">
              <Form.Label>Data Comandă *</Form.Label>
              <Form.Control
                type="date"
