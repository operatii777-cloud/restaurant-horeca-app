            ...
            <Card className="text-center">
              <Card.Body>
                ...
                <h6 className="text-muted">
                  {stats.oldest_archived_date ? formatDate(stats.oldest_archived_date) : 'â€”'}
                </h6>
              </Card.Body>
            </Card>
          </Col>
          <Col md={3}>
            <Card className="text-center">
              <Card.Body>
                ...
                <h6 className="text-muted">
                  {stats.newest_archived_date ? formatDate(stats.newest_archived_date) : 'â€”'}
                </h6>
              </Card.Body>
            </Card>
          </Col>
                  ...
                  <tbody>
                    {automationRules.map((rule) => (
                      <tr key={rule.id}>
                        ...
                        <td>{rule.next_run ? formatDate(rule.next_run) : 'â€”'}</td>
                        <td>
