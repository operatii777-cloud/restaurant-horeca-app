  ...
  return (
    <div className="technical-sheets-page">
      <div className="d-flex justify-content-between align-items-center mb-3">
        <PageHeader 
          title="fise tehnice de produs"
          subtitle="Conform Ordin ANSVSA 201/2022 + UE 1169/2011"
        />
        <HelpButton
          title="ajutor fise tehnice de produs"
          content={
            <div>
        ...
        <Card.Body>
          <div className="d-flex justify-content-between align-items-center mb-3">
            ...
            <Button variant="primary" onClick={() => setShowModal(true)}>
              <i className="fas fa-plus me-2"></i>"genereaza fisa noua"</Button>
          </div>
          ...
          {loading ? (
            ...
            <Alert variant="info">"nu exista fise tehnice genereaza prima fisa din re"</Alert>
          ) : (
                    ...
                    <tr key={sheet.id}>
                      ...
                      <td>
                        {allergens.length > 0 ? (
                          ...
                          <Badge bg="success">"fara alergeni"</Badge>
                        )}
                      </td>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>"genereaza fisa tehnica"</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Alert variant="info">
          ...
          <Form>
            <Form.Group className="mb-3">
              ...
              {products.length === 0 && !loadingProducts && (
                <Form.Text className="text-muted">"nu exista produse cu retete definite"</Form.Text>
              )}
            </Form.Group>
            ...
            <Form.Group className="mb-3">
              ...
              {selectedProductId && !loadingRecipes && recipes.length === 0 && (
                <Form.Text className="text-warning">"acest produs nu are retete definite"</Form.Text>
              )}
              {selectedProductId && loadingRecipes && (
                <Form.Text className="text-muted">"se incarca retetele"</Form.Text>
              )}
            </Form.Group>
          </Form>
        </Modal.Body>
        <Modal.Footer>
          ...
          >
            {generating ? (
              <>
                <span className="spinner-border spinner-border-sm me-2" />"se genereaza"</>
            ) : (
