...
//   const { t } = useTranslation();
  ...
  return (
    <div className="kiosk-users-page">
      <PageHeader
        title="Utilizatori KIOSK"
        subtitle="gestionare username si parola pentru ospatari supe"
      />
        ...
        <Card.Body>
          {loading ? (
            ...
            <Alert variant="info" className="text-center">
              <i className="fas fa-info-circle me-2"></i>"nu exista utilizatori adauga primul utilizator"</Alert>
          ) : (
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Modal.Footer>
            <Button variant="secondary" onClick={handleCloseModal}>
              <i className="fas fa-times me-2"></i>"Anulează"</Button>
