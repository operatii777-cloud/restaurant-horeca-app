      ...
      <form onSubmit={handleSubmit} className="restaurant-config-form">
        <div className="restaurant-config-form__section">
          <h3 className="restaurant-config-form__section-title">
            <span className="restaurant-config-form__section-icon">🏢</span>"date persoana juridica"</h3>
          ...
          <div className="restaurant-config-form__grid">
            ...
            <div className="restaurant-config-form__field restaurant-config-form__field--full">
              ...
              <textarea
                ...
                placeholder={t('$([ex_strada_principala_123_sector_1_bucuresti] -replace "\[|\]")')}
                required
              />
              <small className="restaurant-config-form__help">"adresa completa cu sectorul si orasul"</small>
            </div>
            ...
            <div className="restaurant-config-form__field">
              ...
              />
              <small className="restaurant-config-form__help">"numarul de telefon al restaurantului"</small>
            </div>
            ...
            <div className="restaurant-config-form__field">
              ...
              <input
                ...
                placeholder='[ex_contact@restaurantro]'
              />
          ...
          <div className="restaurant-config-form__grid">
            <div className="restaurant-config-form__field">
              ...
              <input
                ...
                required
              />
              <small className="restaurant-config-form__help">"codul de identificare fiscala"</small>
            </div>
            ...
            <div className="restaurant-config-form__field">
              ...
              />
              <small className="restaurant-config-form__help">"numarul din registrul comertului"</small>
            </div>
            ...
            <div className="restaurant-config-form__field">
              ...
              />
              <small className="restaurant-config-form__help">"numele bancii"</small>
            </div>
        ...
        <div className="restaurant-config-form__section">
          <h3 className="restaurant-config-form__section-title">
            <span className="restaurant-config-form__section-icon">⚙️</span>"settings documente fiscale"</h3>
          ...
          <div className="restaurant-config-form__grid">
            ...
            <div className="restaurant-config-form__field">
              ...
              <input
                ...
                step={0.01}
              />
              <small className="restaurant-config-form__help">"tva pentru alimente si mancare"</small>
            </div>
            ...
            <div className="restaurant-config-form__field">
              ...
              <input
                ...
                step={0.01}
              />
              <small className="restaurant-config-form__help">"tva pentru bauturi alcoolice si non alcoolice"</small>
            </div>
          </div>
        </div>
