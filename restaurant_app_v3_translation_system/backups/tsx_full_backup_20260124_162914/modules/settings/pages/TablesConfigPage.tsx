    ...
    <div className="tables-config-page">
      <div className="tables-config-page__header">
        <div>
          ...
          <p className="tables-config-page__subtitle">"configureaza fiecare masa zona numar locuri forma "</p>
        </div>
      ...
      <div className="tables-config-page__filters">
        <div className="tables-config-page__filter">
          <label htmlFor="areaFilter" className="tables-config-page__filter-label">"filtreaza dupa zona"</label>
          <select
            id="areaFilter"
