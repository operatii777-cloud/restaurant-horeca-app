...
import type { CancelledOrder, OrderFilter } from '@/types/orders';
    ...
    <div className="cancelled-orders-panel">
      <div className="cancelled-orders-panel__filters">
        ...
        <div className="cancelled-orders-panel__quick">
          <button type="button" className="btn btn-ghost" onClick={() => handleQuickRange('today')}>
            Astăzi
          </button>
          ...
          <button type="button" className="btn btn-ghost" onClick={() => handleQuickRange('month')}>
            Ultima lună
          </button>
          <button type="button" className="btn btn-ghost" onClick={() => handleQuickRange('all')}>
            Toate
          </button>
        </div>
      ...
      {!loading && orders.length > 0 ? (
        <div className="cancelled-orders-summary">
          <span>
            Total comenzi anulate: <strong>{orders.length}</strong>
          </span>
          <span>
            Valoare totală pierdută: <strong>{totalValue.toFixed(2)} RON</strong>
          </span>
        </div>
      ) : null}
