...
interface UnitOfMeasure {
  ...
  name: string;
  symbol: string;
  category: 'masa' | 'volum' | 'lungime' | 'bucati' | 'altul';
        ...
        <Card.Body>
          {loading ? (
            ...
            <Alert variant="info">
              ...
              Nu există unități de măsură. Adaugă prima unitate!
            </Alert>
          ) : (
            ...
            <Row>
              ...
              <Col md={6}>
                <Form.Group className="mb-3">
                  ...
                  <Form.Text className="text-muted">
                    Unitatea față de care se face conversia
                  </Form.Text>
                </Form.Group>
              </Col>
            </Row>
