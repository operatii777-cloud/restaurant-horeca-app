      ...
      <div className="risk-alerts-drawer">
          ...
          <div className="row g-2">
            <div className="col-6">
              ...
              >
                ...
                <option value="high_variance">Varianță Mare</option>
                <option value="expiring_soon">Expiră Curând</option>
                <option value="low_turnover">Rotație Scăzută</option>
                <option value="cost_increase">Creștere Cost</option>
              </select>
            </div>
            <div className="col-6">
              <select
        ...
        {loading ? (
          <div className="text-center py-4">
            ...
            <p className="mt-2">Se încarcă alertele...</p>
          </div>
          ...
          <div className="text-center text-muted py-4">
            ...
            <p>Nu există alerte de risc pentru filtrele selectate.</p>
          </div>
        )}
      </div>
    </SideDrawer>
