...
export const StockPredictionPage = () => {
  ...
  return (
    <div className="stock-prediction-page" data-page-ready="true">
      <PageHeader
        title="Predicție Stoc"
        description="Predicție stocuri bazată pe analiza ABC și viteză de consum."
        actions={[
          {
      ...
      {!loading && predictions.length === 0 && (
        <div className="text-center py-5 text-muted">
          ...
          <p>Nu există predicții disponibile. Rulează predicția pentru a vedea rezultatele.</p>
        </div>
      )}
    </div>
  );
