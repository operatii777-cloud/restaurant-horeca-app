    ...
    return (
      <div className="executive-dashboard-page">
        ...
        <div className="text-center py-5">
          ...
          <p className="mt-3">Se încarcă dashboard-ul executiv...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="executive-dashboard-page">
      <Card className="shadow-sm mb-4">
        <Card.Header className="bg-primary text-white d-flex justify-content-between align-items-center">
          <h5 className="mb-0">
            <i className="fas fa-tachometer-alt me-2"></i>Dashboard Executiv - Multi-Gestiune
          </h5>
          <div>
        ...
        <Card.Body>
          ...
          <Row className="mb-4">
            <Col md={6}>
              <Card>
                <Card.Header>
                  <h6 className="mb-0">Valoare Stoc per Locație</h6>
                </Card.Header>
                <Card.Body>
                  {stockValue.length === 0 ? (
                    <p className="text-muted text-center py-4">Nu există date disponibile</p>
                  ) : (
            ...
            <Col md={6}>
              <Card>
                <Card.Header>
                  <h6 className="mb-0">Distribuție Varianță per Locație</h6>
                </Card.Header>
                <Card.Body>
          ...
          <Row className="mb-4">
            <Col md={12}>
              <Card>
                <Card.Header>
                  <h6 className="mb-0">Comparație KPI per Locație</h6>
                </Card.Header>
                <Card.Body>
