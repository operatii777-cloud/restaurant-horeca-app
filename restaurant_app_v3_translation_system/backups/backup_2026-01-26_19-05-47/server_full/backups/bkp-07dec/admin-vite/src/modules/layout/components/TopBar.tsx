      ...
      <header className="topbar topbar--compact">
        ...
        <div className="topbar__right">
            ...
            <button
              ...
              onClick={(e) => {
                ...
                if (isKiosk) {
                  e.preventDefault();
                  e.stopPropagation();
                  console.log('⚠️ TopBar login button apăsat în KIOSK - ignorat');
                  return;
                }
          ...
          <div className="topbar__qroms-badge">
            ...
            >
              <img src="/QrOMS.jpg" alt="QrOMS" className="qroms-badge-img" onError={(e) => {
                (e.target as HTMLImageElement).src = '/Trattoria.jpg';
              }} />
