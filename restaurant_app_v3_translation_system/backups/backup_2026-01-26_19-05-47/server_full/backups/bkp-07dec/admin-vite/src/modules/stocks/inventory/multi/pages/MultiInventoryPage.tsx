...
export const MultiInventoryPage: React.FC = () => {
  ...
  const columnDefs = [
    ...
    { field: 'started_at', headerName: 'Dată Început', width: 180, valueFormatter: (params: any) => new Date(params.value).toLocaleString('ro-RO') },
      ...
      cellRenderer: (params: any) => {
        ...
        return `
          <div>
            ...
            ${session.status === 'in_progress' ? `<button class="btn btn-sm btn-success" onclick="window.finalizeSession(${session.id})">Finalizează</button>` : ''}
          </div>
        `;
      }
    }
    ...
    <div className="multi-inventory-page">
      <div className="page-header">
        ...
        <button className="btn btn-primary" onClick={() => setShowNewModal(true)}>
          <i className="fas fa-plus me-1"></i>Sesiune Nouă
        </button>
      </div>
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <div className="mb-3">
                  ...
                  <select className="form-select" value={newSession.session_type} onChange={(e) => setNewSession({...newSession, session_type: e.target.value})}>
