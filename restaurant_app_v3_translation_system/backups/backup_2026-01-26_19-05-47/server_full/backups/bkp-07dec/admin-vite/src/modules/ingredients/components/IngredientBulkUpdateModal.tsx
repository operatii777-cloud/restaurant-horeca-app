...
export function IngredientBulkUpdateModal({
  ...
  return (
    <Modal
      isOpen={open}
      onClose={onClose}
      title="Actualizare în masă a ingredientelor"
      ...
      <form className="ingredient-bulk-form" onSubmit={handleSubmit}>
        ...
        <fieldset className="ingredient-bulk-visibility">
          ...
          <label>
            ...
            />
            Marchează drept neinventariabil
          </label>
          <label>
            <input
              type="radio"
            ...
            />
            Restaurează ingredientele ascunse
          </label>
        </fieldset>

        <footer className="ingredient-bulk-actions">
          <button type="button" className="ingredient-bulk-button ingredient-bulk-button--ghost" onClick={onClose} disabled={loading}>
            Anulează
          </button>
