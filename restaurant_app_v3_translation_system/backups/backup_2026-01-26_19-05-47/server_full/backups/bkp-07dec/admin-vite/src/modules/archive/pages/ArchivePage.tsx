  ...
  return (
    <div className="archive-page">
      ...
      <Tabs activeKey={activeTab} onSelect={(k) => k && setActiveTab(k)} className="mb-4">
        <Tab eventKey="archive" title="📦 Arhivă Comenzi">
          <Card>
        ...
        <Tab eventKey="automations" title="⚙️ Automatizări">
          <Card>
            <Card.Header>
            ...
            <Card.Body>
              <Alert variant="info" className="mb-4">
                ...
                Automatizările vă permit să programați acțiuni periodice pentru arhivare, backup și curățare.
              </Alert>

              {automationRules.length === 0 ? (
                <Alert variant="info">Nu există reguli de automatizare configurate</Alert>
              ) : (
        ...
        <Tab eventKey="statistics" title="📊 Statistici">
          <Card>
            <Card.Header>
              <h5 className="mb-0">Statistici Arhivă pe Lună</h5>
            </Card.Header>
            <Card.Body>
              {loading ? (
                ...
                <Alert variant="info">Nu există date pentru statistici</Alert>
              )}
            </Card.Body>
          </Card>
        </Tab>
