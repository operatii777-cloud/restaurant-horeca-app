...
export const FiscalReportXPage = () => {
  ...
  const generateReportX = async () => {
    ...
    try {
      const response = await httpClient.get('/api/reports/x-report', {
        params: {
          date: reportDate,
        },
      });
  ...
  return (
    <div className="fiscal-report-x-page">
      <Card className="shadow-sm">
        ...
        <Card.Body>
          <p className="text-muted">Raportul X se generează pentru a afișa totalurile zilnice de la casă.</p>
                ...
                <Card className="mt-3">
                  ...
                  <Card.Body>
                    ...
                    <Alert variant="info">
                      ...
                      <br />
                      Poți vizualiza rapoartele X generate în secțiunea <strong>"Arhivă"</strong> din tab-ul fiscal.
                    </Alert>
                  </Card.Body>
                </Card>
              )}
