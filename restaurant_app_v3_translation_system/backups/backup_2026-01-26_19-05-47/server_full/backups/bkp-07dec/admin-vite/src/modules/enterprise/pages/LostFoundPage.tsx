    ...
    <div className="lostfound-page">
      ...
      <Card className="mt-4 shadow-sm">
        <Card.Header className="bg-white">
          <h5 className="mb-0">Obiecte Găsite</h5>
        </Card.Header>
      ...
      <Modal show={showAddModal} onHide={() => setShowAddModal(false)} centered>
        <Modal.Header closeButton>
          <Modal.Title><i className="fas fa-plus me-2"></i>Obiect Găsit Nou</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
            ...
            <Form.Group className="mb-3">
              <Form.Label>Locație Găsire</Form.Label>
              <Form.Select
      ...
      <Modal show={showReturnModal} onHide={() => setShowReturnModal(false)} centered>
        ...
        <Modal.Footer>
          ...
          <Button variant="success" onClick={handleReturn}>
            <i className="fas fa-check me-2"></i>Confirmă Returnare
          </Button>
        </Modal.Footer>
      </Modal>
    </div>
