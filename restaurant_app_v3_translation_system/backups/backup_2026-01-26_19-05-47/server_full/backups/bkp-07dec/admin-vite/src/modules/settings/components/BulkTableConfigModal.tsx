    ...
    >
      <form onSubmit={handleSubmit} className="bulk-table-config-form">
        <div className="bulk-table-config-form__info">
          <p>
            Configurează mesele de la <strong>{startTable}</strong> la <strong>{endTable}</strong>.
            <br />
        ...
        <div className="bulk-table-config-form__field">
          <label htmlFor="startTable" className="bulk-table-config-form__label">
            Masă de la
          </label>
          <input
            type="number"
        ...
        <div className="bulk-table-config-form__field">
          <label htmlFor="endTable" className="bulk-table-config-form__label">
            Masă până la
          </label>
          <input
            type="number"
        ...
        <div className="bulk-table-config-form__field">
          <label htmlFor="bulkZone" className="bulk-table-config-form__label">
            Zonă
          </label>
          <select
            id="bulkZone"
        ...
        <div className="bulk-table-config-form__field">
          <label htmlFor="bulkSeats" className="bulk-table-config-form__label">
            Număr locuri
          </label>
          <input
            type="number"
        ...
        <div className="bulk-table-config-form__field">
          <label htmlFor="bulkShape" className="bulk-table-config-form__label">
            Formă
          </label>
          <select
            id="bulkShape"
