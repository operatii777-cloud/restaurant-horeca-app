...
export const AdvancedReportsPage: React.FC = () => {
  ...
  const getRevenueChartData = () => {
    return {
      labels: revenueChart.map((item) => new Date(item.date).toLocaleDateString('ro-RO', { day: '2-digit', month: '2-digit' })),
      datasets: [
        {
          label: 'Venituri (RON)',
  ...
  return (
    <div className="advanced-reports-page">
      <PageHeader
        ...
        description="Dashboard avansat cu metrici detaliate, grafice interactive și alerte"
      />
        ...
        <Tab eventKey="overview" title="📊 Overview">
          <Row>
            <Col md={8}>
              <Card>
                <Card.Header>
                  <h5 className="mb-0">Evoluție Venituri</h5>
                </Card.Header>
                <Card.Body>
                  {loading ? (
                  ...
                  <Table striped hover responsive>
                    ...
                    <tbody>
                      {revenueChart.map((item, index) => {
                        const prevRevenue = index > 0 ? revenueChart[index - 1].revenue : item.revenue;
          ...
          <Card>
            ...
            <Card.Body>
              {loading ? (
                ...
                <Alert variant="success">
                  <i className="fas fa-check-circle me-2"></i>
                  Nu există alerte de inventar! Toate ingredientele au stoc suficient.
                </Alert>
              ) : (
                <>
                  {inventoryAlerts.length > 0 && (
