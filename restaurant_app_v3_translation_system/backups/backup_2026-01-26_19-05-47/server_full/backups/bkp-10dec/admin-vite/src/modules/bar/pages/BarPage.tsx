      ...
      <header className="bar-header">
        ...
        <div className="bar-stats">
          <span className="bar-stat-item">
            ...
            <span className="bar-stat-value">{getPendingCount()}</span>
          </span>
          <span className="bar-stat-item">
            <span className="bar-stat-label">Preparing:</span>
            <span className="bar-stat-value">{getPreparingCount()}</span>
          </span>
          <span className="bar-stat-item">
            <span className="bar-stat-label">Ready:</span>
            <span className="bar-stat-value">{getReadyCount()}</span>
          </span>
          <span className="bar-stat-item">
