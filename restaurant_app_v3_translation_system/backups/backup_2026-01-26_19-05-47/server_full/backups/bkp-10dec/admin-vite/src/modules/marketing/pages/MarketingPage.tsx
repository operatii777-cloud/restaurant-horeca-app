            ...
            <Card.Body>
              ...
              {segments.length === 0 && (
                <div className="text-center py-4 text-muted">
                  ...
                  <p>Nu există segmente. Rulează segmentarea automată pentru a crea segmente.</p>
                </div>
              )}
            </Card.Body>
          </Card>
        ...
        <div className="col-md-8">
          <Card>
            <Card.Header>
              ...
              Gestiune Campanii de Marketing
            </Card.Header>
            <Card.Body>
              <p className="text-muted">
                Creează campanii de reduceri sau fidelizare, țintind segmentele de clienți definite.
              </p>
              {campaigns.length === 0 ? (
                <div className="text-center py-4 text-muted">
