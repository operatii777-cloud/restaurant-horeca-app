  ...
  return (
    <Modal show={show} onHide={handleClose} size="lg">
      <Modal.Header closeButton className="bg-success text-white">
        <Modal.Title>
          <i className="fas fa-file-upload me-2"></i>Import Factură
        </Modal.Title>
      </Modal.Header>
      <Modal.Body>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <div className="d-flex justify-content-end gap-2">
            ...
            <Button variant="success" type="submit" disabled={loading || success}>
              {loading ? (
                <>
                  <i className="fas fa-spinner fa-spin me-1"></i>Se importă...
                </>
              ) : (
                <>
                  <i className="fas fa-upload me-1"></i>Importă Factură
                </>
              )}
            </Button>
          </div>
