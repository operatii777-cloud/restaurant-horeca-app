  ...
  const getStatusBadge = () => {
    ...
    return config.anaf_enabled ? (
      <Badge bg="success" className="p-2">
        <i className="fas fa-check-circle me-2"></i>PRODUCȚIE
      </Badge>
    ) : (
  ...
  return (
    <div className="anaf-integration-page">
      ...
      <Alert variant="warning" className="mt-3">
        ...
        <p className="mb-2">ANAF Integration este în <strong>MOD SANDBOX</strong> (test mode).</p>
        <ul className="mb-0">
            ...
            <div className="col-md-6">
              <div className="input-group">
                ...
                <Button variant="primary" onClick={validateCUI} disabled={validatingCui}>
                  <i className={`fas ${validatingCui ? 'fa-spinner fa-spin' : 'fa-search'} me-2`}></i>
                  Validează CUI
                </Button>
              </div>
            </div>
            ...
            <div className="mt-3">
              {cuiResult.valid ? (
                <Alert variant="success">
                  <h5 className="alert-heading">
                    <i className="fas fa-check-circle me-2"></i>CUI Valid
                  </h5>
                  {cuiResult.data && (
                    <>
      ...
      <Card className="mb-4">
        ...
        <Card.Body>
          <div className="row">
            <div className="col-md-6">
              <Form.Label>Dată Raport Z:</Form.Label>
              <div className="input-group">
                <Form.Control
                  type="date"
                  value={raportZDate}
            ...
            <div className="mt-3">
              {transmissionResult.simulated ? (
                <Alert variant="warning">
                  <h5 className="alert-heading">
                    <i className="fas fa-flask me-2"></i>Transmisie SIMULATĂ
                  </h5>
