                ...
                <Form.Group className="mb-3">
                  ...
                  <div className="d-flex gap-2">
                    ...
                    <Button variant="secondary" onClick={generateBarcode}>
                      <i className="fas fa-sync-alt"></i> Generează
                    </Button>
                  </div>
                </Form.Group>
            ...
            <Card.Header className="bg-white d-flex justify-content-between align-items-center">
              ...
              <div className="d-flex gap-2">
                <Button variant="success" onClick={handlePrintLabel}>
                  <i className="fas fa-print me-2"></i>Imprimă
                </Button>
                <Button variant="primary" onClick={handleDownloadPDF}>
                  <i className="fas fa-download me-2"></i>Descarcă PDF
                </Button>
              </div>
            </Card.Header>
            <Card.Body>
          ...
          <Card className="shadow-sm">
            ...
            <Card.Body>
              ...
              <Button variant="warning" onClick={handlePrintBatch} className="w-100">
                <i className="fas fa-print me-2"></i>Imprimă în Lot
              </Button>
            </Card.Body>
          </Card>
        </div>
