...
import DownloadPdfButton from "../../tipizate/DownloadPdfButton";
import { getProductionBatchPdfUrl } from "../../tipizate/tipizateApi";
    ...
    <div className="p-4 flex flex-col gap-4">
      <div className="flex justify-between items-center">
        ...
        {!isNew && batch?.status === "completed" && (
          <DownloadPdfButton
            url={getProductionBatchPdfUrl(id)}
            label="PDF Fișă fabricație"
            className="text-xs"
          />
        )}
      </div>
