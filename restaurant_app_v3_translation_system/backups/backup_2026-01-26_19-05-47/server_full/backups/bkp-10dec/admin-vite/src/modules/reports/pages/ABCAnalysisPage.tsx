...
export const ABCAnalysisPage = () => {
  ...
  return (
    <div className="abc-analysis-page">
      <h2 className="mb-4">Analiză ABC a Produselor Vândute</h2>
      <Card className="shadow-sm mb-4">
        <Card.Header className="bg-primary text-white d-flex justify-content-between align-items-center">
          <h5 className="mb-0">
            <i className="fas fa-chart-pie me-2"></i>Analiză ABC Produse
          </h5>
        ...
        <Card.Body>
          ...
          <Row className="mb-4">
            ...
            <Col md={4}>
              <Card className="shadow-sm">
                <Card.Header>
                  <h6>
                    <i className="fas fa-chart-pie me-1"></i>Distribuție Venituri
                  </h6>
                </Card.Header>
                <Card.Body>
                  {pieChartData ? (
          ...
          <Card className="shadow-sm">
            <Card.Header>
              <h6>
                <i className="fas fa-list me-1"></i>Lista Completă Produse - Clasificare ABC
              </h6>
            </Card.Header>
            <Card.Body>
