                ...
                <Card.Body>
                  ...
                  {table.session_id ? (
                    <>
                      ...
                      >
                        <i className="fas fa-times me-2"></i>Închide Sesiune
                      </Button>
                    </>
                  ) : (
                    <Button
                    ...
                    >
                      <i className="fas fa-plus me-2"></i>Deschide Sesiune
                    </Button>
                  )}
                </Card.Body>
              </Card>
      ...
      <Modal show={showSessionModal} onHide={() => setShowSessionModal(false)} centered>
          ...
          <Form>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                ...
                placeholder="Lasă gol dacă nu e alocat"
              />
            </Form.Group>
            <Form.Group className="mb-3">
        ...
        <Modal.Footer>
          ...
          <Button variant="success" onClick={handleStartSession}>
            <i className="fas fa-check me-2"></i>Deschide Sesiune
          </Button>
        </Modal.Footer>
      </Modal>
    </div>
