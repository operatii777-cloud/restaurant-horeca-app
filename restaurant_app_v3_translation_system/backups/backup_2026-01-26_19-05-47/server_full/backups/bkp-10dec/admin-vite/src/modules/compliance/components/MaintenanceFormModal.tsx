        ...
        <form onSubmit={handleSubmit} className="modal-body">
          ...
          <div className="form-group">
            ...
            <select
              ...
              required
              title="Selectează tipul mentenanței"
              aria-label="Selectează tipul mentenanței"
            >
          ...
          <div className="form-group">
            ...
            <input
              ...
              required
              title="Data și ora programată"
              aria-label="Data și ora programată"
            />
          </div>
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              placeholder="Descriere mentenanță"
            />
          </div>
        </form>
