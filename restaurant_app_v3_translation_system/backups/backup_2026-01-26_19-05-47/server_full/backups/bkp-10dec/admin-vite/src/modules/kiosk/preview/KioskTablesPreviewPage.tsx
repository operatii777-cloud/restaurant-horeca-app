    ...
    <div className="kiosk-preview-page">
      <div className="kiosk-preview-container">
        <header className="kiosk-preview-header">
          ...
          <p>Demonstrație pentru interfața de selecție mese în KIOSK</p>
        </header>
        ...
        <section className="kiosk-preview-variant variant-1">
          ...
          <div className="variant-description">
            Design modern cu efect glassmorphism, animații fluide și feedback vizual clar pentru statusul mesei.
          </div>
        ...
        <section className="kiosk-preview-variant variant-2">
          ...
          <div className="variant-description">
            Design minimalist și curat, focus pe funcționalitate și claritate vizuală.
          </div>
          <div className="tables-grid">
            {mockTables.map((table) => (
              <div
        ...
        <section className="kiosk-preview-variant variant-3">
          ...
          <div className="variant-description">
            Design vibrant cu culori distincte pentru fiecare status, ideal pentru medii cu iluminare puternică.
          </div>
          <div className="tables-grid">
            {mockTables.map((table) => (
              <div
