      ...
      <header className="kds-header">
        ...
        <div className="kds-stats">
          <span className="kds-stat-item">
            ...
            <span className="kds-stat-value">{getPendingCount()}</span>
          </span>
          <span className="kds-stat-item">
            <span className="kds-stat-label">Preparing:</span>
            <span className="kds-stat-value">{getPreparingCount()}</span>
          </span>
          <span className="kds-stat-item">
            <span className="kds-stat-label">Ready:</span>
            <span className="kds-stat-value">{getReadyCount()}</span>
          </span>
          <span className="kds-stat-item">
