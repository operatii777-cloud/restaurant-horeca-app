...
export function IngredientEditorModal({ open, ingredient, onClose, onSaved }: IngredientEditorModalProps) {
  ...
  const defaultValues = useMemo<IngredientFormValues>(() => {
    if (!ingredient) {
      return {
        ...
        min_stock: undefined,
        max_stock: undefined,  // ✅ SĂPTĂMÂNA 1 - ZIUA 4
        safety_stock: undefined,  // ✅ SĂPTĂMÂNA 1 - ZIUA 4
        reorder_quantity: undefined,  // ✅ SĂPTĂMÂNA 1 - ZIUA 4
        purchase_unit: undefined,  // ✅ SĂPTĂMÂNA 2 - ZIUA 4
        recipe_unit: undefined,  // ✅ SĂPTĂMÂNA 2 - ZIUA 4
        inventory_unit: undefined,  // ✅ SĂPTĂMÂNA 2 - ZIUA 4
        purchase_to_inventory_factor: undefined,  // ✅ SĂPTĂMÂNA 2 - ZIUA 4
        inventory_to_recipe_factor: undefined,  // ✅ SĂPTĂMÂNA 2 - ZIUA 4
    ...
    return {
      ...
      max_stock: (ingredient as any).max_stock ?? undefined,  // ✅ SĂPTĂMÂNA 1 - ZIUA 4
      safety_stock: (ingredient as any).safety_stock ?? undefined,  // ✅ SĂPTĂMÂNA 1 - ZIUA 4
      reorder_quantity: (ingredient as any).reorder_quantity ?? undefined,  // ✅ SĂPTĂMÂNA 1 - ZIUA 4
      purchase_unit: (ingredient as any).purchase_unit ?? undefined,  // ✅ SĂPTĂMÂNA 2 - ZIUA 4
      recipe_unit: (ingredient as any).recipe_unit ?? undefined,  // ✅ SĂPTĂMÂNA 2 - ZIUA 4
      inventory_unit: (ingredient as any).inventory_unit ?? undefined,  // ✅ SĂPTĂMÂNA 2 - ZIUA 4
      purchase_to_inventory_factor: (ingredient as any).purchase_to_inventory_factor ?? undefined,  // ✅ SĂPTĂMÂNA 2 - ZIUA 4
      inventory_to_recipe_factor: (ingredient as any).inventory_to_recipe_factor ?? undefined,  // ✅ SĂPTĂMÂNA 2 - ZIUA 4
  ...
  const fields = useMemo<SmartFormField[]>(
    () => [
      ...
      // ✅ SĂPTĂMÂNA 2 - ZIUA 4: Purchase Units
      {
        name: 'purchase_unit',
  ...
  const onSubmit = async (values: IngredientFormValues) => {
    ...
    const payload: Record<string, unknown> = {
      ...
      max_stock: (values as any).max_stock ?? null,  // ✅ SĂPTĂMÂNA 1 - ZIUA 4
      safety_stock: (values as any).safety_stock ?? null,  // ✅ SĂPTĂMÂNA 1 - ZIUA 4
      reorder_quantity: (values as any).reorder_quantity ?? null,  // ✅ SĂPTĂMÂNA 1 - ZIUA 4
      purchase_unit: (values as any).purchase_unit ?? null,  // ✅ SĂPTĂMÂNA 2 - ZIUA 4
      recipe_unit: (values as any).recipe_unit ?? null,  // ✅ SĂPTĂMÂNA 2 - ZIUA 4
      inventory_unit: (values as any).inventory_unit ?? null,  // ✅ SĂPTĂMÂNA 2 - ZIUA 4
      purchase_to_inventory_factor: (values as any).purchase_to_inventory_factor ?? null,  // ✅ SĂPTĂMÂNA 2 - ZIUA 4
      inventory_to_recipe_factor: (values as any).inventory_to_recipe_factor ?? null,  // ✅ SĂPTĂMÂNA 2 - ZIUA 4
