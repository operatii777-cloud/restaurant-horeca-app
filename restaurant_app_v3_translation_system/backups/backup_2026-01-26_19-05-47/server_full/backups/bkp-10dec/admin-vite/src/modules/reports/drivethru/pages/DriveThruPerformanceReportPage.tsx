  ...
  return (
    <div className="drivethru-performance-page">
        ...
        <Card.Body>
          <Row>
            <Col md={6}>
              ...
              <p><strong>Valoare Medie Comandă:</strong> {data.summary.avg_order_value.toFixed(2)} RON</p>
            </Col>
            <Col md={6}>
      ...
      {data.by_lane.length === 0 && (
        <Card>
          <Card.Body className="text-center py-5">
            <p className="text-muted">Nu există date pentru breakdown pe bandă.</p>
          </Card.Body>
        </Card>
      )}
    </div>
