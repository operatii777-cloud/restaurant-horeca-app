  ...
  if (loading && !data) {
    return (
      <div className="queue-monitor-page">
        <PageHeader title="📊 Monitor Coadă" description="Monitorizare coadă comenzi și job-uri" />
      ...
      <div className="queue-monitor-page">
        ...
        <Alert variant="danger">
          ...
          <Button variant="outline-danger" size="sm" className="ms-3" onClick={loadQueueMonitor}>
            <i className="fas fa-redo me-1"></i>Reîncearcă
          </Button>
        </Alert>
      </div>
    );
                  ...
                  {failedJobs.map((job) => (
                    <div key={job.jobId} className="list-group-item">
                      <div className="d-flex justify-content-between align-items-start">
                        ...
                        <Badge bg="warning">Retries: {job.retries}</Badge>
                      </div>
                    </div>
                  ))}
                </div>
      ...
      <Row>
        ...
        <Col md={6}>
          <Card className="shadow-sm mb-4">
            <Card.Header className="bg-white">
              <h5 className="mb-0">
                <i className="fas fa-tachometer-alt me-1"></i> Performance Metrics
              </h5>
            </Card.Header>
            <Card.Body>
