  ...
  return (
    ...
    >
      <div className="ingredient-details">
        ...
        {loading ? <p className="ingredient-details__loading">Se încarcă detaliile...</p> : null}
        ...
        {ingredient && activeTab === 'overview' ? (
          <section className="ingredient-details__section">
            ...
            <ul className="ingredient-details__list">
              ...
              <li>
                <span>Temperatură depozitare</span>
                <strong>
          ...
          <section className="ingredient-details__section">
            ...
            <form className="ingredient-document-form" onSubmit={handleSubmitDocument}>
              ...
              <label>
                ...
                <textarea
                  ...
                  placeholder="Ex: Verificat temperatura la recepție 4°C."
                />
              </label>
            ...
            <table className="ingredient-details__table">
              ...
              <tbody>
                {documents.length === 0 ? (
                  <tr>
                    <td colSpan={6} className="ingredient-details__empty">
          ...
          <section className="ingredient-details__section">
            ...
            <table className="ingredient-details__table">
              ...
              <tbody>
                {suppliers.length === 0 ? (
                  <tr>
                    <td colSpan={5} className="ingredient-details__empty">
                      Nu sunt furnizori asociați acestui ingredient.
                    </td>
                  </tr>
                ) : (
                  suppliers.map((link) => (
        ...
        {activeTab === 'traceability' ? (
          <section className="ingredient-details__section">
            <h3>Trasabilitate loturi și comenzi</h3>
            <table className="ingredient-details__table">
              <thead>
                <tr>
                  <th>ID Comandă</th>
              ...
              <tbody>
                {formattedTraceRows.length === 0 ? (
                  <tr>
                    <td colSpan={8} className="ingredient-details__empty">
                      Nu există trasabilitate disponibilă pentru acest ingredient.
                    </td>
                  </tr>
                ) : (
