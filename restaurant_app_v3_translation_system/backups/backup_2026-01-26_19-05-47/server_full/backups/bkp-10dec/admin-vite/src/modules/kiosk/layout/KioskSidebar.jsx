  ...
  const menuGroups = [
    {
      ...
      items: [
        ...
        { id: 'kds-kitchen', label: 'KDS Bucătărie', icon: ChefHat, external: '/kds.html' },
        { id: 'kds-bar', label: 'KDS Bar', icon: Beer, external: '/comenzi bar.html' },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'stocks', label: 'Stocuri & NIR', icon: PackageOpen, path: '/stocks' },
