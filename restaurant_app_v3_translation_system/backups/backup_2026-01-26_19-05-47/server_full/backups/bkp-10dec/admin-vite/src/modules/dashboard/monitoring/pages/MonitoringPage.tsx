...
export const MonitoringPage: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'queue' | 'performance'>('overview');
  ...
  const loadMetrics = async () => {
    try {
      ...
      if (systemResponse.ok) {
        ...
        setSystemMetrics(systemData.system || null);
      }
  ...
  return (
    <div style={{ padding: '20px' }}>
      <div className="page-header" style={{ marginBottom: '20px' }}>
        <h1><i className="fas fa-tachometer-alt me-2"></i>Monitoring & Performance Dashboard</h1>
            ...
            <div className="col-md-4">
              <div className="card">
                <div className="card-header bg-primary text-white">
                  <h5><i className="fas fa-server me-2"></i>System Metrics</h5>
                </div>
                <div className="card-body">
                  {systemMetrics ? (
                    <>
                      <div className="mb-3">
                        <strong>Response Time:</strong> {systemMetrics.response_time || 0}ms
                      </div>
                      <div className="mb-3">
                        <strong>Active Connections:</strong> {systemMetrics.active_connections || 0}
                      </div>
                      <div className="mb-3">
                        <strong>Memory Usage:</strong> {Math.round((systemMetrics.memory?.heapUsed || 0) / 1024 / 1024)}MB
                      </div>
                    </>
                  ) : (
                    <p>Se încarcă...</p>
            ...
            <div className="col-md-4">
              <div className="card">
                <div className="card-header bg-success text-white">
                  <h5><i className="fas fa-utensils me-2"></i>Order Metrics</h5>
                </div>
                <div className="card-body">
                  {orderMetrics ? (
                    <>
            ...
            <div className="col-md-4">
              <div className="card">
                <div className="card-header bg-warning text-dark">
                  <h5><i className="fas fa-exclamation-triangle me-2"></i>Alerts</h5>
                </div>
                <div className="card-body">
