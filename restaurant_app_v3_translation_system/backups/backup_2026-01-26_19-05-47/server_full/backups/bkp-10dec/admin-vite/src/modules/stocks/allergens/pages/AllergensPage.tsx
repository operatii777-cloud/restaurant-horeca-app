    ...
    <div className="allergens-page">
        ...
        <div className="col-md-3">
          <Card className="text-center shadow-sm border-danger">
            <Card.Body>
              ...
              <p className="text-muted mb-0">Cu Diferențe</p>
            </Card.Body>
          </Card>
        </div>
        <div className="col-md-3">
      ...
      {loading ? (
        <div className="text-center mt-4">
          <Spinner animation="border" size="sm" className="me-2" /> Se încarcă produsele...
        </div>
      ) : (
        ...
        <Modal.Body>
          {selectedProduct && (
            <>
              ...
              <h5 className="mt-3">Selectează Alergenii:</h5>
              ...
              <Form.Group className="mt-3">
                <Form.Label>Alergeni Selectați:</Form.Label>
                <Form.Control 
                  type="text" 
