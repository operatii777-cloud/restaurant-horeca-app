    ...
    <div className="variance-reports-page page">
      ...
      <Card className="mb-4">
        <Card.Body>
          <Form.Group className="mb-3">
            <Form.Label>Selectează Data</Form.Label>
            <div className="d-flex gap-2">
              ...
              <Button variant="secondary" onClick={loadVariances}>
                Încarcă Raport
              </Button>
            </div>
          </Form.Group>
      ...
      <Card>
        <Card.Body>
          ...
          {variances.length === 0 ? (
            <Alert variant="info">
              Nu există date variance pentru această dată. Calculează variance mai întâi.
            </Alert>
          ) : (
