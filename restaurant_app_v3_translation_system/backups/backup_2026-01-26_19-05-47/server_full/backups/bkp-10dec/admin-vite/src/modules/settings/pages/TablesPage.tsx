        ...
        <Card.Header className="bg-warning text-dark d-flex justify-content-between align-items-center">
          ...
          <div>
            ...
            <Button variant="light" size="sm" onClick={() => handleOpenModal()}>
              <i className="fas fa-plus me-1"></i>Masă Nouă
            </Button>
          </div>
        </Card.Header>
        <Card.Body>
          <Alert variant="info">
            ...
            Configurează fiecare masă: zonă, număr locuri, formă. Folosit pentru plan amplasament și raportare.
          </Alert>
      ...
      <Modal show={showBulkModal} onHide={() => setShowBulkModal(false)} size="lg">
        ...
        <Modal.Body>
          <Form onSubmit={handleBulkSubmit}>
            <Alert variant="info">
              Creează multiple mese deodată. Mesele vor fi create cu aceleași setări pentru toate.
            </Alert>
