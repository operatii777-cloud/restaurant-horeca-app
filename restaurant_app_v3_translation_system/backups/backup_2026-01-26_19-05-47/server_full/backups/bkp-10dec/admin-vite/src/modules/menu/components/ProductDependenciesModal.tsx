      ...
      <div className="dependencies-layout">
        <section className="dependencies-section">
          <header className="dependencies-header">
            <div>
              <h3>Ingrediente rețetă</h3>
              <p>Lista ingredientelor din rețeta asociată produsului.</p>
            </div>
          ...
          {loading ? (
            ...
            <div className="dependencies-empty">Nu există ingrediente definite pentru acest produs.</div>
          ) : (
        ...
        <section className="dependencies-section">
          <header className="dependencies-header">
            <div>
              ...
              <p>Alte produse care folosesc aceleași ingrediente.</p>
            </div>
          </header>
          ...
          {loading ? (
            ...
            <div className="dependencies-empty">Nu au fost găsite produse care folosesc ingrediente comune.</div>
          ) : (
