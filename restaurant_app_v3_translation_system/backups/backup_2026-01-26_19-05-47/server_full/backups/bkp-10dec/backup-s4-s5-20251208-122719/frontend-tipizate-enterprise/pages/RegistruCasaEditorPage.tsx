/**
 * PHASE S5.6 - Registru Casă Editor Page
 * Enterprise editor page for Registru Casă documents
 */
...
export default function RegistruCasaEditorPage() {
  const {
    form,
    setForm,
    lines,
    ...
    pdfOpen,
    setPdfOpen,
  } = useTipizatEditor('REGISTRU_CASA');
