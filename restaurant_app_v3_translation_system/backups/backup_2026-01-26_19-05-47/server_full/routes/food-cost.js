...
// ==================== GET PRODUCTS WITH FOOD COST ====================
router.get('/products', async (req, res) => {
    try {
        // Get products with their recipes and calculate food cost
        ...
        console.error('Error fetching food cost products:', err);
...
router.post('/suggest-price', async (req, res) => {
    try {
        ...
        res.json({
            ...
            suggested_price: Math.ceil(suggestedPrice * 100) / 100 // Round up to 2 decimals
        });
    } catch (err) {
