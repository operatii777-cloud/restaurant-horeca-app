...
type ModalProps = {
  ...
  draggable?: boolean; // âœ… Prop pentru drag and drop
  positionStorageKey?: string; // âœ… Key pentru localStorage
};
...
//   const { t } = useTranslation();
  ...
  // âœ… Restaurează poziția din localStorage când modalul se deschide
  useEffect(() => {
  ...
  // âœ… Salvează poziția în localStorage când se schimbă
  useEffect(() => {
  ...
  // âœ… Hook pentru drag and drop - trebuie să fie întotdeauna declarat
  useEffect(() => {
...
//   const { t } = useTranslation();
  ...
  // âœ… Handlers pentru drag and drop - doar pe header
