    ...
    <div className="cancelled-orders-panel">
      <div className="cancelled-orders-panel__filters">
        ...
        <div className="cancelled-orders-panel__quick">
          ...
          <button type="button" className="btn btn-ghost" onClick={() => handleQuickRange('month')}>"ultima luna"</button>
        ...
        <div className="cancelled-orders-panel__actions">
          <button type="button" className="btn btn-primary" onClick={handleApplyFilters}>"aplica filtre"</button>
      ...
      {loading ? <p>"se incarca comenzile anulate"</p> : null}
      ...
      {!loading && orders.length > 0 ? (
        <div className="cancelled-orders-summary">
          ...
          <span>"valoare totala pierduta"<strong>{totalValue.toFixed(2)} RON</strong>
          </span>
        </div>
      ) : null}
        ...
        {orders.map((order) => {
          ...
          <article key={order.id} className="cancelled-order-card">
            ...
            <div className="cancelled-order-card__meta">
              ...
              <p>
                <strong>"data anularii"</strong> {formatTimestamp(order.cancelled_timestamp)}
              </p>
