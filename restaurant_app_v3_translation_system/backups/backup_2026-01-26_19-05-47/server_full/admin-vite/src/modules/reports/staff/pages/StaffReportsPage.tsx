...
//   const { t } = useTranslation();
  ...
  const columnDefs = [
    { field: 'waiter', headerName: 'OspÄƒtar', width: 200 },
    { field: 'count', headerName: 'Nr. Comenzi', width: 150 },
    { field: 'total', headerName: 'Total VÃ¢nzÄƒri', width: 150, valueFormatter: (params: any) => `${params.value.toFixed(2)} RON` },
    { field: 'average', headerName: 'Medie/ComandÄƒ', width: 150, valueFormatter: (params: any) => `${params.value.toFixed(2)} RON` }
  ];
