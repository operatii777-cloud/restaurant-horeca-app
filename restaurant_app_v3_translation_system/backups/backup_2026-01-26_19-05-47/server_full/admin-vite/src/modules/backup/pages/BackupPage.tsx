    ...
    <div className="backup-page" data-page-ready="true">
      ...
      <section className="backup-page__stats">
        ...
        <StatCard
          ...
          value={archiveMetrics?.activeOrders != null ? archiveMetrics.activeOrders.toString() : '—'}
          helper="În baza de date curentă"
          icon="📋"
        />
        <StatCard
          title="Comenzi arhivate"
          value={archiveMetrics?.archivedOrders != null ? archiveMetrics.archivedOrders.toString() : '—'}
          helper={
      ...
      <section className="backup-page__timeline">
        ...
        <ul className="backup-page__timeline-list">
          {timelineItems.length === 0 ? (
            <li className="backup-page__timeline-empty">"nu exista inca backup uri inregistrate"</li>
          ) : (
