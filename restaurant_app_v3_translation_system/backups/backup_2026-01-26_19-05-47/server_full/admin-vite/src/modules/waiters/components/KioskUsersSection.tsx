        ...
        <Form onSubmit={handleSubmit}>
          <Modal.Body>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Text className="text-muted">"rolul determina nivelul de acces in kiosk"</Form.Text>
            </Form.Group>
            ...
            <Form.Group className="mb-3">
              ...
              />
              <Form.Text className="text-muted">"utilizatorii inactivi nu pot accesa kiosk"</Form.Text>
            </Form.Group>
          </Modal.Body>
          <Modal.Footer>
            <Button variant="secondary" onClick={handleCloseModal}>
              <i className="fas fa-times me-2"></i>"anuleaza"</Button>
