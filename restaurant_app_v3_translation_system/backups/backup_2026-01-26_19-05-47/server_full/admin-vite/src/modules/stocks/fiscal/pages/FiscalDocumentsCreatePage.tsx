    ...
    <div className="fiscal-documents-create-page">
      <Card className="shadow-sm">
        <Card.Header className="bg-success text-white">
          <i className="fas fa-plus-circle me-1"></i>"creare documente fiscale"</Card.Header>
        <Card.Body>
          {feedback && (
            ...
            <div className="col-md-6">
              ...
              <Form onSubmit={handleReceiptSubmit}>
                <Form.Group className="mb-3">
                  <Form.Label>"selecteaza comanda"</Form.Label>
                  <Form.Select
                  ...
                  <Form.Text className="text-muted">"comenzile sunt grupate pe zile pentru usurinta"</Form.Text>
                </Form.Group>
            ...
            <div className="col-md-6">
              ...
              <Form onSubmit={handleInvoiceSubmit}>
                <Form.Group className="mb-3">
                  ...
                  <Form.Text className="text-muted">"selecteaza o comanda pentru a pre popula datele sa"</Form.Text>
                </Form.Group>
                ...
                <Form.Group className="mb-3">
                  <Form.Label>"suma totala"</Form.Label>
                  <Form.Control
                    type="number"
                    step="0.01"
