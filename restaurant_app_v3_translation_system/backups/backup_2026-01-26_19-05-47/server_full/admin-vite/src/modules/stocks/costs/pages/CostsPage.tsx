...
//   const { t } = useTranslation();
  ...
  const loadProducts = async () => {
    ...
    try {
      ...
      setFeedback({ type: 'error', message: 'Eroare la Ã®ncÄƒrcarea costurilor' });
    } finally {
      setLoading(false);
    }
  };
  ...
  const getFoodCostLevel = (foodCostPercent: number) => {
    if (foodCostPercent < 25) {
      return { label: 'Excelent', badge: 'success', icon: 'âœ…' };
    } else if (foodCostPercent < 30) {
      return { label: 'Bun', badge: 'info', icon: 'ðŸ‘' };
    } else if (foodCostPercent < 35) {
      return { label: 'AtenÈ›ie', badge: 'warning', icon: 'âš ï¸' };
    } else {
  ...
  return (
    <div className="costs-page">
      <PageHeader
        ...
        description="AnalizÄƒ costuri, preÈ›uri È™i profitabilitate produse"
      />
        ...
        <Card.Body>
          <div className="row">
            <div className="col-md-3 mb-3">
              <Badge bg="success" className="p-2 mb-2 d-block">âœ… Excelent: &lt; 25%</Badge>
            ...
            <div className="col-md-3 mb-3">
              <Badge bg="warning" className="p-2 mb-2 d-block">âš ï¸ AtenÈ›ie: 30-35%</Badge>
        ...
        <Card.Header className="d-flex justify-content-between align-items-center">
          ...
          <div>
            <Button variant="success" className="me-2" onClick={loadProducts}>
              <i className="fas fa-sync-alt me-2"></i>"ReÃ®ncarcÄƒ"</Button>
          </div>
        </Card.Header>
        <Card.Body>
          {/* Filters */}
          <div className="row mb-3">
            ...
            <div className="col-md-4">
              ...
              >
                ...
                <option value="excellent">âœ… Excelent (&lt;25%)</option>
                <option value="good">ðŸ‘ Bun (25-30%)</option>
                <option value="warning">âš ï¸ AtenÈ›ie (30-35%)</option>
      ...
      <div className="row">
        ...
        <div className="col-md-6">
          <Card>
            <Card.Header>
              <h5 className="mb-0">
                <i className="fas fa-exclamation-triangle me-2"></i>Top 5 NecesitÄƒ AtenÈ›ie
              </h5>
            </Card.Header>
            <Card.Body>
