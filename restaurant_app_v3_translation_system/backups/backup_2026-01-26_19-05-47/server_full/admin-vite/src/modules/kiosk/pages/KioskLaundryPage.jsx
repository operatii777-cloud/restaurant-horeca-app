 ...
 * - Atribuire la mese sau angajați
 * - Istoric spălări
 * - Statistici
 */
...
export const KioskLaundryPage = () => {
  ...
  const handleAssign = async () => {
    ...
    try {
      ...
      setFeedback({ type: 'success', message: 'Textil atribuit cu succes!' });
  ...
  const handleUnassign = async (id) => {
    ...
    try {
      ...
      setFeedback({ type: 'success', message: 'Textil dezatribuit!' });
      loadData();
    } catch (error) {
      console.error('Error unassigning item:', error);
      setFeedback({ type: 'error', message: 'Eroare la dezatribuire' });
    }
  };
