...
interface PriceRule {
  id?: number;
  name: string;
  rule_type: 'cost_multiplier' | 'margin_target' | 'percentage_change' | 'fixed_change' | "Formulă";
...
//   const { t } = useTranslation();
  ...
  // Bulk Update State
  const [bulkUpdateType, setBulkUpdateType] = useState<'fixed' | 'percentage' | "Formulă">('percentage');
    ...
    <div className="price-utilities-page">
      ...
      <Card className="shadow-sm">
        <Card.Body>
          <Tabs activeKey={activeTab} onSelect={(k) => k && setActiveTab(k)} className="mb-4">
            ...
            <Tab eventKey="bulk-update" title={<><i className="fas fa-edit me-1"></i>"actualizare in masa"</>}>
              <div className="mt-4">
                <Row>
                  <Col md={6}>
                ...
                <div className="d-flex gap-2 mb-4">
                  <Button
                    ...
                    disabled={loading}
                  >
                    <i className="fas fa-eye me-1"></i>"preview modificari"</Button>
            ...
            {/* Tab: Istoric Prețuri */}
            <Tab eventKey="history" title={<><i className="fas fa-history me-1"></i>"istoric preturi"</>}>
              <div className="mt-4">
                <Form.Group className="mb-3">
                ...
                {priceHistory.length === 0 ? (
                  <Alert variant="info">
                    <i className="fas fa-info-circle me-2"></i>"nu exista istoric de preturi"</Alert>
                ) : (
                  <div className="table-responsive">
            ...
            <Tab eventKey="rules" title={<><i className="fas fa-cog me-1"></i>"reguli automate"</>}>
              <div className="mt-4">
                <div className="d-flex justify-content-between align-items-center mb-3">
                  ...
                  >
                    <i className="fas fa-plus me-1"></i>"adauga regula"</Button>
                </div>

                {priceRules.length === 0 ? (
                  <Alert variant="info">
                    <i className="fas fa-info-circle me-2"></i>"nu exista reguli de pret creeaza prima regula"</Alert>
                ) : (
                  <div className="table-responsive">
                    <Table striped bordered hover>
                      <thead>
      ...
      <Modal show={showRuleModal} onHide={() => setShowRuleModal(false)} size="lg">
        ...
        <Form onSubmit={handleRuleSubmit}>
          ...
          <Modal.Footer>
            <Button variant="secondary" onClick={() => setShowRuleModal(false)}>"Anulează"</Button>
