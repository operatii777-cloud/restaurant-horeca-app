 ...
 * OSRM Configuration
 * 
 * NOTE: Folosește același OSRM endpoint ca FriendsRide (configurabil în .env)
 * Dacă FriendsRide folosește un OSRM specific, setează OSRM_URL în .env
 */
const OSRM_CONFIG = {
  // Folosește OSRM din FriendsRide sau local
  baseUrl: process.env.OSRM_URL || process.env.FRIENDSRIDE_OSRM_URL || 'http://localhost:5000',
