...
const SCREENSHOTS_DIR = path.join(__dirname, 'server', 'screenshots');
const MANUAL_PATH = path.join(__dirname, 'server', 'MANUAL-INSTRUCTIUNI-COMPLETE.md');
...
const SCREENSHOT_DOCUMENTATION = [
  ...
  // ========================================
  {
    ...
    sections: [
      ...
      '- **Data Expirare:** Alertă produse aproape expirate',
...
`;
  ...
  // Scrie fișierul
  try {
    require('fs').writeFileSync(MANUAL_PATH, markdownContent, 'utf8');
